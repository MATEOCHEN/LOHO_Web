...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-JhengHei">
        ...
        <li class="breadcrumb-item active" aria-current="page">輝煌獎項</li>
    </ol>
</nav>
<div class="content">
        ...
        <div class="row">
            <div class="left-block">
                <div class="list-group-block text-JhengHei">
                    <h1 class="my-4 title-color">輝煌獎項</h1>
            ...
            <div class="col right-block">
                ...
                <img src="{{ URL::asset('/Image/award/14b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    樂活董事長─劉信佑獲頒國家產業創新獎
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/award/15b.jpg') }}" alt="">
            </div>
        </div>
    </div>
</div>
