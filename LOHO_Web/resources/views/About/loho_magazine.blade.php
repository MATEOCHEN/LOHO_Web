...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-JhengHei">
        ...
        <li class="breadcrumb-item active" aria-current="page">雜誌專刊</li>
    </ol>
</nav>
<div class="content">
        ...
        <div class="row">
            <div class="left-block">
                <div class="list-group-block text-JhengHei">
                    <h1 class="my-4 title-color">雜誌專刊</h1>
            ...
            <div class="col right-block">
                <img src="{{ URL::asset('/Image/magazine/57b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    樂活織襪工廠變身 社頭觀光起飛
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/27b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    遠見雜誌專題報導
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/24b.jpg') }}" alt="">
                <img src="{{ URL::asset('/Image/magazine/21b.jpg') }}" alt="">
                <img src="{{ URL::asset('/Image/magazine/20b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    襪！觀光工廠新鮮趣
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/26b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    織襪王國 千里之行始於足下
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/25b.jpg') }}" alt="">
                <img src="{{ URL::asset('/Image/magazine/25-3b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    創LOHO品牌、引進政府輔導新材質機能 沒落產業重生
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/23b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    看雜誌-以創意樂活風帶動地方產業
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/22b.jpg') }}" alt="">
                <img src="{{ URL::asset('/Image/magazine/22-3b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    好運囍字襪禮盒 報導
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/19b.jpg') }}" alt="">
                <div class="text-block">
                    <p>
                    中國服裝店 The Fashion Shop 專題報導
                    </p>
                </div>
                <img src="{{ URL::asset('/Image/magazine/18b.jpg') }}" alt="">
            </div>
        </div>
    </div>
</div>
