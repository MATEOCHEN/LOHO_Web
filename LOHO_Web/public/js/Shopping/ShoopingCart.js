    ...
    var Item_added = function(item_name,item_price,item_count,img_url) {
        ...
        $("#showBlock").append("<div id='div1" + txtID +"' class='col-6  text-left solid-top-border border'>"
        ...
        "<div class='col-2  text-center solid-top-border border' id='div4" + txtID +"'>"
        +"<p id='size"+txtID+"'>無</p></div>",
        "<div class='col-2  text-center solid-top-border border' id='div5" + txtID +"'>"
        ...
        "<div class='col-2   text-center solid-top-border border' id='div6" + txtID +"'>"
